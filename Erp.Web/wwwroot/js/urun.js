$(document).ready(function () {
    ...
    $('#excelBtn').click(function () {
        var data = [], headers = [];
        $('#urunTable thead tr:first th').each(function () { headers.push($(this).text()); });
        data.push(headers);
        $('#urunTable tbody tr').each(function () {
            var row = [];
    ...
    $('#printBtn').click(function () {
        ...
        w.document.write('<html><head><title>Ürün Kartları</title><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/css/bootstrap.min.css"></head><body>');
        w.document.write('<h3>Ürün Kartları</h3>' + document.getElementById('urunTable').outerHTML + '</body></html>');
